...
class AVisTDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        frames_list = ['{}/img_{:05d}.jpg'.format(frames_path, frame_number) for frame_number in
                       range(1, ground_truth_rect.shape[0] + 1)]
        return Sequence(sequence_name, frames_list, 'avist', ground_truth_rect.reshape(-1, 4),
